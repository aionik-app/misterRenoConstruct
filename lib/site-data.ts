...
export async function loadSiteConfig(): Promise<SiteConfig> {
  try {
    ...
    return await import("@/data/site-config.json").then((module) => module.default)
  }
}
...
export function generateDefaultConfig(
  ...
  return {
    ...
    services: [
      {
        ...
        description: "Entretien régulier de votre pelouse pour un gazon parfait toute l'année.",
        image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop",
        price: "À partir de 35€",
        features: ["Tonte professionnelle", "Ramassage des déchets", "Bordures nettes", "Conseils d'entretien"],
        icon: "🌱",
      },
    ...
    about: {
      ...
      features: ["15 ans d'expérience", "Équipe certifiée", "Matériaux de qualité", "Devis gratuit"],
    },
    gallery: {
    ...
    footer: {
      description: "Votre partenaire de confiance pour tous vos projets d'aménagement extérieur.",
      socialLinks: [],
      quickLinks: [

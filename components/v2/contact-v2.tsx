...
export function ContactV2({ config }: ContactV2Props) {
    ...
    <section id="contact" className="py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">Parlons de votre projet</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Prêt à transformer votre espace extérieur ? Contactez-nous pour un devis personnalisé et gratuit
          </p>
        </div>
          ...
          <div className="lg:col-span-8">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8 lg:p-12">
                <h3 className="text-2xl font-bold text-foreground mb-8">Demande de devis gratuit</h3>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Appelez-nous directement</p>
                  </div>
                </div>
                <p className="text-foreground font-medium text-lg">{config.contact.phone}</p>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Écrivez-nous</p>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Venez nous voir</p>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-80 text-sm">Nous sommes disponibles</p>
                  </div>
                </div>

...
export function AboutV2({ config }: AboutV2Props) {
  const values = [
    {
      icon: Leaf,
      title: "Écologique",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">{config.about.title}</h2>

            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">{config.about.description}</p>
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                <img
                  src={config.about.image || "/placeholder.svg?height=500&width=400&query=gardening team at work"}
                  alt="Notre équipe"
              ...
              <div className="absolute -bottom-4 right-8 w-16 h-16 bg-primary/20 rounded-full blur-lg"></div>
            </div>
          </div>
        </div>
      </div>

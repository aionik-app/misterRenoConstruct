			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-20">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
						De la conception à l'entretien, nous transformons vos espaces
						extérieurs en véritables œuvres d'art naturelles
					</p>
				</div>
							...
							<div className="relative h-80 lg:h-96 overflow-hidden">
								<Image
									src={
										...
										"/placeholder.svg?height=400&width=600&query=lawn mowing service"
									}
									alt={config.services[0]?.title || "Service image"}
									fill
						...
						>
							<div className="relative h-48 overflow-hidden rounded-t-lg">
								<Image
									src={
										service.image ||
										"/placeholder.svg?height=200&width=300&query=gardening service"
									}

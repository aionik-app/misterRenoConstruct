			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
						Chaque projet est unique et reflète notre passion pour l'art du
						jardinage
					</p>
						...
						>
							<div className="relative overflow-hidden">
								<Image
									src={
										image.url ||
										"/placeholder.svg?height=400&width=300&query=garden project"
									}
									alt={image.alt}
									width={400} // largeur approximative pour Next.js
									height={300} // hauteur approximative

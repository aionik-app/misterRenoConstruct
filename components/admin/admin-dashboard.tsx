...
import { LogOut, Save, Eye, Settings, Palette, FileText, ImageIcon, MessageSquare, Phone, Key } from "lucide-react"
    ...
    <div className="min-h-screen bg-muted/30">
      ...
      {saveMessage && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <Alert
            className={saveMessage.includes("succès") ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}
          >
